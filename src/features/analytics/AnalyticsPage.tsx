...
import { BarChart3, ChartNoAxesCombined, PieChart, Receipt, ShoppingBasket, Trophy, Wallet } from 'lucide-react'
...
export function AnalyticsPage({ direction = 1, groceries, members, loading = false, error = null, onRetry }: AnalyticsPageProps) {
  ...
  return (
    <PageTransition direction={direction}>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <motion.div variants={riseChild}>
          <Card icon={Receipt} title="Most expensive groceries" headingLevel={2} subtitle="Ranked by total spent, across every real grocery logged.">
